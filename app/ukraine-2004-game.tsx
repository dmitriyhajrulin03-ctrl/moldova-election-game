...
const ALL_CANDIDATES: CandidateBase[] = [
    { id: 'yushchenko', nameUk: 'Віктор Ющенко', nameRu: 'Виктор Ющенко', party: 'Самовисування', logoSrc: 'https://placehold.co/64x64/f97316/ffffff?text=ВЮ', photoSrc: 'https://placehold.co/160x160/1e3a8a/ffffff?text=Ющенко', color: '#F97316', baseRating: 39.9, political_spectrum: 'pro_eu' },
    { id: 'yanukovych', nameUk: 'Віктор Янукович', nameRu: 'Виктор Янукович', party: 'Партія регіонів', logoSrc: 'https://placehold.co/64x64/1d4ed8/ffffff?text=ВЯ', photoSrc: 'https://placehold.co/160x160/1d4ed8/ffffff?text=Янукович', color: '#1D4ED8', baseRating: 39.26, political_spectrum: 'pro_ru' },
    { id: 'moroz', nameUk: 'Олександр Мороз', nameRu: 'Александр Мороз', party: 'Соціалістична партія України', logoSrc: 'https://placehold.co/64x64/16a34a/ffffff?text=ОМ', photoSrc: 'https://placehold.co/160x160/16a34a/ffffff?text=Мороз', color: '#16A34A', baseRating: 5.82, political_spectrum: 'centrist' },
    { id: 'symonenko', nameUk: 'Петро Симоненко', nameRu: 'Пётр Симоненко', party: 'Комуністична партія України', logoSrc: 'https://placehold.co/64x64/dc2626/ffffff?text=ПС', photoSrc: 'https://placehold.co/160x160/dc2626/ffffff?text=Симоненко', color: '#DC2626', baseRating: 4.97, political_spectrum: 'pro_ru' },
    { id: 'vitrenko', nameUk: 'Наталія Вітренко', nameRu: 'Наталия Витренко', party: 'Прогресивна соціалістична партія України', logoSrc: 'https://placehold.co/64x64/991b1b/ffffff?text=НВ', photoSrc: 'https://placehold.co/160x160/991b1b/ffffff?text=Вітренко', color: '#991B1B', baseRating: 1.53, political_spectrum: 'pro_ru' },
    { id: 'kinakh', nameUk: 'Анатолій Кінах', nameRu: 'Анатолий Кинах', party: 'Партія промисловців і підприємців', logoSrc: 'https://placehold.co/64x64/0ea5e9/ffffff?text=АК', photoSrc: 'https://placehold.co/160x160/0ea5e9/ffffff?text=Кінах', color: '#0EA5E9', baseRating: 0.93, political_spectrum: 'centrist' },
    { id: 'yakovenko', nameUk: 'Олександр Яковенко', nameRu: 'Александр Яковенко', party: 'Комуністична партія робітників і селян', logoSrc: 'https://placehold.co/64x64/b91c1c/ffffff?text=ОЯ', photoSrc: 'https://placehold.co/160x160/b91c1c/ffffff?text=Яковенко', color: '#B91C1C', baseRating: 0.78, political_spectrum: 'pro_ru' },
    { id: 'omelchenko', nameUk: 'Олександр Омельченко', nameRu: 'Александр Омельченко', party: 'Партія «Єдність»', logoSrc: 'https://placehold.co/64x64/0284c7/ffffff?text=ОО', photoSrc: 'https://placehold.co/160x160/0284c7/ffffff?text=Омельченко', color: '#0284C7', baseRating: 0.48, political_spectrum: 'centrist' },
    { id: 'chernovetskyi', nameUk: 'Леонід Черновецький', nameRu: 'Леонид Черновецкий', party: 'Самовисування', logoSrc: 'https://placehold.co/64x64/0d9488/ffffff?text=ЛЧ', photoSrc: 'https://placehold.co/160x160/0d9488/ffffff?text=Черновецький', color: '#0D9488', baseRating: 0.46, political_spectrum: 'centrist' },
    { id: 'korchynskyi', nameUk: 'Дмитро Корчинський', nameRu: 'Дмитрий Корчинский', party: 'Самовисування', logoSrc: 'https://placehold.co/64x64/7c3aed/ffffff?text=ДК', photoSrc: 'https://placehold.co/160x160/7c3aed/ffffff?text=Корчинський', color: '#7C3AED', baseRating: 0.17, political_spectrum: 'pro_ru' },
    { id: 'chornovil', nameUk: 'Андрій Чорновіл', nameRu: 'Андрей Черновол', party: 'Самовисування', logoSrc: 'https://placehold.co/64x64/facc15/0f172a?text=АЧ', photoSrc: 'https://placehold.co/160x160/facc15/0f172a?text=Чорновіл', color: '#FACC15', baseRating: 0.12, political_spectrum: 'pro_eu' },
    { id: 'hrabar', nameUk: 'Микола Грабар', nameRu: 'Николай Грабарь', party: 'Самовисування', logoSrc: 'https://placehold.co/64x64/4b5563/ffffff?text=МГ', photoSrc: 'https://placehold.co/160x160/4b5563/ffffff?text=Грабар', color: '#4B5563', baseRating: 0.07, political_spectrum: 'centrist' },
    { id: 'brodskyi', nameUk: 'Михайло Бродський', nameRu: 'Михаил Бродский', party: 'Самовисування', logoSrc: 'https://placehold.co/64x64/22c55e/ffffff?text=МБ', photoSrc: 'https://placehold.co/160x160/22c55e/ffffff?text=Бродський', color: '#22C55E', baseRating: 0.05, political_spectrum: 'pro_eu' },
    { id: 'zbitnev', nameUk: 'Юрій Збітнєв', nameRu: 'Юрий Збитнев', party: 'Партія «Нова сила»', logoSrc: 'https://placehold.co/64x64/2563eb/ffffff?text=ЮЗ', photoSrc: 'https://placehold.co/160x160/2563eb/ffffff?text=Збітнєв', color: '#2563EB', baseRating: 0.05, political_spectrum: 'pro_eu' },
    { id: 'komissarenko', nameUk: 'Сергій Комісаренко', nameRu: 'Сергей Комиссаренко', party: 'Самовисування', logoSrc: 'https://placehold.co/64x64/14b8a6/ffffff?text=СК', photoSrc: 'https://placehold.co/160x160/14b8a6/ffffff?text=Комісаренко', color: '#14B8A6', baseRating: 0.04, political_spectrum: 'pro_eu' },
    { id: 'volha', nameUk: 'Василь Волга', nameRu: 'Василий Волга', party: 'Партія «Громадський контроль»', logoSrc: 'https://placehold.co/64x64/ea580c/ffffff?text=ВВ', photoSrc: 'https://placehold.co/160x160/ea580c/ffffff?text=Волга', color: '#EA580C', baseRating: 0.04, political_spectrum: 'pro_ru' },
    { id: 'boiko', nameUk: 'Богдан Бойко', nameRu: 'Богдан Бойко', party: 'Рух українських патріотів', logoSrc: 'https://placehold.co/64x64/16a34a/ffffff?text=ББ', photoSrc: 'https://placehold.co/160x160/16a34a/ffffff?text=Бойко', color: '#16A34A', baseRating: 0.04, political_spectrum: 'centrist' },
    { id: 'rzhavskyi', nameUk: 'Олександр Ржавський', nameRu: 'Александр Ржавский', party: 'Партія «Єдина родина»', logoSrc: 'https://placehold.co/64x64/c026d3/ffffff?text=ОР', photoSrc: 'https://placehold.co/160x160/c026d3/ffffff?text=Ржавський', color: '#C026D3', baseRating: 0.03, political_spectrum: 'pro_ru' },
    { id: 'rohozhynskyi', nameUk: 'Микола Рогожинський', nameRu: 'Николай Рогожинский', party: 'Самовисування', logoSrc: 'https://placehold.co/64x64/9333ea/ffffff?text=МР', photoSrc: 'https://placehold.co/160x160/9333ea/ffffff?text=Рогожинський', color: '#9333EA', baseRating: 0.03, political_spectrum: 'pro_ru' },
    { id: 'kryvobokov', nameUk: 'Владислав Кривобоков', nameRu: 'Владислав Кривобоков', party: 'Народна партія вкладників соцзахисту', logoSrc: 'https://placehold.co/64x64/0f766e/ffffff?text=ВК', photoSrc: 'https://placehold.co/160x160/0f766e/ffffff?text=Кривобоков', color: '#0F766E', baseRating: 0.03, political_spectrum: 'centrist' },
    { id: 'bazilyuk', nameUk: 'Олександр Базилюк', nameRu: 'Александр Базилюк', party: "Слов'янська партія України", logoSrc: 'https://placehold.co/64x64/fb7185/ffffff?text=ОБ', photoSrc: 'https://placehold.co/160x160/fb7185/ffffff?text=Базилюк', color: '#FB7185', baseRating: 0.03, political_spectrum: 'pro_ru' },
    { id: 'dushyn', nameUk: 'Ігор Душин', nameRu: 'Игорь Душин', party: 'Ліберально-демократична партія України', logoSrc: 'https://placehold.co/64x64/0e7490/ffffff?text=ІД', photoSrc: 'https://placehold.co/160x160/0e7490/ffffff?text=Душин', color: '#0E7490', baseRating: 0.03, political_spectrum: 'centrist' },
    { id: 'kozak', nameUk: 'Роман Козак', nameRu: 'Роман Козак', party: 'Організація українських націоналістів', logoSrc: 'https://placehold.co/64x64/f97316/ffffff?text=РК', photoSrc: 'https://placehold.co/160x160/f97316/ffffff?text=Козак', color: '#F97316', baseRating: 0.02, political_spectrum: 'pro_eu' },
    { id: 'nechyporuk', nameUk: 'Володимир Нечипорук', nameRu: 'Владимир Нечипорук', party: 'Самовисування', logoSrc: 'https://placehold.co/64x64/94a3b8/ffffff?text=ВН', photoSrc: 'https://placehold.co/160x160/94a3b8/ffffff?text=Нечипорук', color: '#94A3B8', baseRating: 0.02, political_spectrum: 'centrist' }
];
